...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email) { [weak self] (exists) in
            ...
            guard !exists else {
                // user already exists
                strongSelf.alertUserLoginError(message: "Looks like a user account for this email exists")
                return
            }
    ...
    func alertUserLoginError(message: String = "Please check the information to create a new account.") {
